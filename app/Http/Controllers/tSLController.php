...
class SLController extends Controller
{
    public function mainHeroes() {
        $heroesArr = [
            ...
            ["id" => "7", "name" => "Hayabusa", "role" => "Assassin", "power" => "2452", "match" => "151", "winrate" => "53.6%", "desc" => "ayabusa - an assassin hero who can deal high physical damage and escape easily. He is ideal for players who enjoy hit-and-run tactics and can easily eliminate low-health enemies."],
            ...
            ["id" => "10", "name" => "Granger", "role" => "Marskman", "power" => "1302", "match" => "108", "winrate" => "52.9%", "desc" => "Granger - a marksman hero who can deal high physical damage from a distance. He is able to move and shoot at the same time, making him difficult to target."],
    ...
    public function detailHeroes($id) {
        $newHero = [];
